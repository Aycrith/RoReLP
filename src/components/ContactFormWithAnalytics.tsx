...
import { trackFormSubmit, trackClick } from '@/lib/gtm';
...
const ContactForm = () => {
  ...
  // Track form submission status changes
  useEffect(() => {
  ...
  const trackFieldInteraction = (fieldName: string) => {
    trackClick(`contact_form_${fieldName}_focused`, 'Form Interaction');
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      trackClick('contact_form_submit', 'Form Submission');
            ...
            {formStatus === 'success' ? (
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-600 mb-4">
                  We&apos;ll get back to you within 24 hours with a personalized quote and next steps.
                </p>
                <p className="text-gray-600 mb-4">
                  Don&apos;t worry - we&apos;ll help you get your equipment running smoothly again!
                </p>
              </div>
            ) : (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  />
                  <p id="phone-optional" className="mt-1 text-xs text-gray-500">
                ...
                <div className="pt-2">
                  <button
                    ...
                    onClick={() => trackClick('contact_form_submit_click', 'Form Submission')}
                  >
                    {getButtonText()}
                  </button>
                </div>
